...
/**
 * Migration: antibot gate settings schema (threshold instead of bypass note).
 */
final class Version20260622230000 extends AbstractMigration
{
    ...
    {
        return 'Migrate site_access_gate_settings to antibot threshold schema.';
    }
    ...
    public function up(Schema $schema): void
    {
        if (!$schema->hasTable('site_access_gate_settings')) {
            $this->addSql('CREATE TABLE site_access_gate_settings (id INT AUTO_INCREMENT NOT NULL, enabled TINYINT(1) DEFAULT 0 NOT NULL, antibot_threshold SMALLINT DEFAULT 50 NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
